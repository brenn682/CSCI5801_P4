...
class Test_Remove_Lines(unittest.TestCase):
    def test_good(self):
        ...
        print("Test_Remove_Lines (test_good) errors: ")
        print(self.assertEqual(back.remove_lines(), True, "Should be true"))
    
    def test_file_not_found(self):
        # set conditions here
        back.ui.attr_nameQuery = 'test3b'
        back.ui.filenameQuery = './testcase_files/file_DNE.py'
        print("Test_Remove_Lines (test_file_not_found) errors: ")
        print(self.assertEqual(back.remove_lines(), False, "Should be False"))
...
class Test_Select_Lines(unittest.TestCase):
    def test_good(self):
        ...
        print("Test_Select_Lines (test_good) errors: ")
        print(self.assertEqual(back.select_lines(), True, "Should be true"))
    
    def test_file_not_found(self):
        # set conditions here
        back.ui.attr_nameQuery = 'test4b'
        back.ui.filenameQuery = './testcase_files/file_DNE.py'
        print("Test_Select_Lines (test_file_not_found) errors: ")
        print(self.assertEqual(back.select_lines(), False, "Should be False"))
...
class Test_Make_Tuple(unittest.TestCase):
    ...
    def test_good(self):
        # set conditions here
        print("Test_Make_Tuple (test_good) errors: ")
        print(self.assertEqual(back.make_tuple(2, 3, 32), True, "Should be true"))
    
    def test_empty_field(self):
        # set conditions here
        print("Test_Make_Tuple (test_empty_field) errors: ")
        print(self.assertEqual(back.make_tuple('', 14, 32), False, "Should be False"))

    def test_snd_ld_fst(self):
        # set conditions here
        print("Test_Make_Tuple (test_snd_ld_fst) errors: ")
        print(self.assertEqual(back.make_tuple(18, 17, 32), False, "Should be False"))

    def test_fst_oob(self):
        # set conditions here
        print("Test_Make_Tuple (test_fst_oob) errors: ")
        print(self.assertEqual(back.make_tuple(-1, 0, 32), False, "Should be False"))

    def test_snd_oob(self):
        # set conditions here
        print("Test_Make_Tuple (test_snd_oob) errors: ")
        print(self.assertEqual(back.make_tuple(32, 33, 32), False, "Should be False"))

    def test_adj_error(self):
        # set conditions here
        print("Test_Make_Tuple (test_adj_error) errors: ")
        print(self.assertEqual(back.make_tuple(5, 7, 32), False, "Should be False"))
...
class Test_Tuple_Lines(unittest.TestCase):
    def test_good(self):
        ...
        print("Test_Tuple_Lines (test_good) errors: ")
        print(self.assertEqual(back.tuple_lines(), True, "Should be true"))
    ...
    def test_file_not_found_source(self):
        ...
        back.ui.filenameQuery = './testcase_files/file_DNE.py'
        print("Test_Tuple_Lines (test_file_not_found_source) errors: ")
        print(self.assertEqual(back.tuple_lines(), False, "Should be False"))
    ...
    def test_file_not_found_solution(self):
        ...
        print("Test_Tuple_Lines (test_file_not_found_solution) errors: ")
        print(self.assertEqual(back.tuple_lines(), False, "Should be False"))
...
class Test_Choice_Made(unittest.TestCase):
    def test_LMS_good(self):
        ...
        print("Test_Choice_Made (test_good) errors: ")
        print(self.assertEqual(back.choice_made('LMS', []), True, "Should be true"))
    ...
    def test_qType_good(self):
        ...
        print("Test_Choice_Made (test_qType_good) errors: ")
        print(self.assertEqual(back.choice_made('qType', sample_options), True, "Should be true"))
    ...
    def test_LMS_choice_invalid(self):
        ...
        print("Test_Choice_Made (test_LMS_choice_invalid) errors: ")
        print(self.assertEqual(back.choice_made('LMS', []), False, "Should be False"))
    ...
    def test_qType_choice_invalid(self):
        ...
        print("Test_Choice_Made (test_qType_choice_invalid) errors: ")
        print(self.assertEqual(back.choice_made('qType', sample_options), False, "Should be False"))
    ...
    def test_mode_parameter_invalid(self):
        ...
        # 'mode3' is erroneous
        print("Test_Choice_Made (test_mode_parameter_invalid) errors: ")
        print(self.assertEqual(back.choice_made('mode3', sample_options), False, "Should be False"))
...
class Test_QType_Select(unittest.TestCase):
    def test_good(self):
        ...
        print("Test_QType (test_good) errors: ")
        print(self.assertEqual(back.qType_select(), True, "Should be true"))
    ...
    def test_LMS_invalid(self):
        ...
        print("Test_QType (test_LMS_invalid) errors: ")
